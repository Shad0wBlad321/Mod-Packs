    ...
    static public class StructureDefGenerator
    {
       ...
       public static void StuffGeneratrs(ThingDef Wallzie)
       {
           if (Wallzie != null)
           {
               ...
               {
                   Wallzie.blueprintDef = (ThingDef)typeof(ThingDefGenerator_Buildings).GetMethod("NewBlueprintDef_Thing", BindingFlags.NonPublic | BindingFlags.Static).Invoke(null, new object[] { Wallzie, false, null });
               ...
               if (Wallzie.frameDef == null)
               {
                   ...
                   Wallzie.frameDef = (ThingDef)typeof(ThingDefGenerator_Buildings).GetMethod("NewFrameDef_Thing", BindingFlags.NonPublic | BindingFlags.Static).Invoke(null, new object[] { Wallzie });
