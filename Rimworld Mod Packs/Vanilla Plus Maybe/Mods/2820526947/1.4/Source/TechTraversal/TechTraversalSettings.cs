...
namespace TechTraversal
{
    public class TechTraversalSettings : ModSettings
    {
        ...
        /// <summary>
        /// If true, changes the calculation to be relative based on number of levels between them.
        /// Vanilla behaviour only changes costs for technology while player tech level is lower than industrial.
        /// </summary>
        public bool adjustTechTiers = true;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref adjustTechTiers, "adjustTechTiers", true);
        }
