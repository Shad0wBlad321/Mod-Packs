...
namespace BillDoorsFramework
{
    public class PenetratingBulletCE : BulletCE
    {
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            intTicksToImpact = AccessTools.FieldRefAccess<int>(typeof(ProjectileCE), "intTicksToImpact");
            startingTicksToImpactInt = AccessTools.FieldRefAccess<float>(typeof(ProjectileCE), "startingTicksToImpactInt");
        ...
        protected AccessTools.FieldRef<object, int> intTicksToImpact;

        protected AccessTools.FieldRef<object, float> startingTicksToImpactInt;
        ...
        public void Retarget()
        {
            ...
            Launch(launcher, new UnityEngine.Vector2(ExactPosition.x, ExactPosition.z), shotAngle, shotRotation, shotHeight, shotSpeed, equipment, 20);
            destinationInt.z = -1f;
            startingTicksToImpactInt(this) = -1;
            intTicksToImpact(this) = -1;
        }
