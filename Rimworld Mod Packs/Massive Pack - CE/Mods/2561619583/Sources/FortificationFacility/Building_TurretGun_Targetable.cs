...
namespace FortificationFacility
{
	...
	public class Building_TurretGun_ForceTargetable : Building_Turret
    {
		...
		protected CompForceTargetable targetableComp;
		...
		public bool IsMannable => targetableComp != null;
		...
		private bool CanSetForcedTarget => (powerComp == null || powerComp.PowerOn) && (dormantComp == null || dormantComp.Awake) && (initiatableComp == null || initiatableComp.Initiated && targetableComp != null);
		...
		public Building_TurretGun_ForceTargetable()
		{
		...
		public override void SpawnSetup(Map map, bool respawningAfterLoad)
		{
			...
			targetableComp = GetComp<CompForceTargetable>();
		...
		public override void Tick()
		{
			...
			if (forcedTarget.IsValid && forcedTarget.Pawn != null && forcedTarget.Pawn.Downed)
			{
				ResetForcedTarget();
			}
			if (Active && (targetableComp == null || MannedByColonist) && !stunner.Stunned && base.Spawned)
			{
		...
		private bool IsValidTarget(Thing t)
		{
			if (t is Pawn pawn)
			{
				if (base.Faction == Faction.OfPlayer && pawn.GuestStatus.HasValue && pawn.GuestStatus == GuestStatus.Prisoner)
				{
					return false;
				}
				if (AttackVerb.ProjectileFliesOverhead())
