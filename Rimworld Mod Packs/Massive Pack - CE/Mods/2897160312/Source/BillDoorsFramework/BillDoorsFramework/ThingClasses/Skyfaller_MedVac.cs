...
namespace BillDoorsFramework
{
    public class Skyfaller_MedEvac : Skyfaller
    {
        ...
        protected override void SpawnThings()
        {
            ...
            if (intendedPawn != null && intendedPawn.Spawned)
            {
                ...
                intendedPawn.DeSpawnOrDeselect();
                landingShip.innerContainer.TryAdd(intendedPawn);
                ...
                if (intendedPawn.IsColonist || intendedPawn.IsPrisonerOfColony)
                {
                    ...
                    if (maps.Any())
                    {
                        ...
                        Log.Message(findBestLandingSpot(map).ToString());
        ...
        {
            {
                if (alreadyLeft || !createWorldObject)
                {
                    ...
                    {
                        foreach (Thing item in (IEnumerable<Thing>)innerContainer[0].TryGetInnerInteractableThingOwner())
                        {
