    ...
    class Projectile_NotBullet : Projectile
    {
        protected override void Impact(Thing hitThing)
        {
            ...
            else
            {
                ...
                if (base.Position.GetTerrain(map).takeSplashes) FleckMaker.WaterSplash(ExactPosition, map, Mathf.Sqrt((float)base.DamageAmount), 4f);
                else FleckMaker.Static(ExactPosition, map, FleckDefOf.ShotHit_Dirt);
            }
        }
    }
}
