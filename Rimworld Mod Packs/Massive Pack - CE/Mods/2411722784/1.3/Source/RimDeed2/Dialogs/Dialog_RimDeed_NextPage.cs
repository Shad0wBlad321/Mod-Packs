...
namespace Rimdeed
{
	public class Dialog_RimDeed_NextPage : Dialog_NodeTree
	{
		...
		public Dialog_RimDeed_NextPage(Pawn negotiator, DiaNode startNode, bool radioMode)
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			Widgets.Label(welcome, "RimDeed.ThankForRequest".Translate());

			Text.Font = GameFont.Small;

			Rect back = new Rect(inRect.x - 250, welcome.yMax + 130, inRect.width - 30f, 999f);
