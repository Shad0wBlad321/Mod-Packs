...
namespace Rimdeed
{
	public class Dialog_RimDeed_BanPage : Dialog_NodeTree
	{
		...
		public Dialog_RimDeed_BanPage(DiaNode startNode, bool radioMode)
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			Rect youAreBanned = new Rect(inRect.x + 120, inRect.y + 260, 360, 30);
			Text.Font = GameFont.Medium;
			GUI.color = Color.red;
			Widgets.Label(youAreBanned, "RimDeed.YouAreBanned".Translate());
			GUI.color = Color.white;
			Text.Font = GameFont.Small;

			Rect banDurationBox = new Rect(youAreBanned.x, youAreBanned.yMax, 360, 40);
			var banDuration = RimdeedManager.Instance.BannedUntil - Find.TickManager.TicksGame;
			Widgets.Label(banDurationBox, "RimDeed.BanDuration".Translate(banDuration.ToStringTicksToDays()));

			Rect rect4 = new Rect(inRect.x + 265, youAreBanned.yMax + 150, inRect.width - 30f, 999f);
